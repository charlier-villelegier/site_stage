                ...
                {addClass: 'btn btn-primary', text: 'Oui', onClick: function ($noty) {
					...
					if(date==""){
						...
						if(parseInt(debut)>=parseInt(fin)){
							...
							$noty.close();
							document.location.href="../../controleurs/enseignant/add_dispo.php?date="+date+"&debut="+debut+"&fin="+fin;
						}
                ...
                {addClass: 'btn btn-primary', text: 'Oui', onClick: function ($noty) {
					...
					if(newDate==""){
						...
						if(parseInt(newDebut)>=parseInt(newFin)){
							...
							$noty.close();
							document.location.href="../../controleurs/enseignant/modif_dispo.php?date="+date+"&newDate="+newDate
        ...
        var n = noty({
            ...
            buttons     : [
                {addClass: 'btn btn-danger', text: 'Oui', onClick: function ($noty) {
                    $noty.close();
					document.location.href="../../controleurs/enseignant/delete_dispo.php?date="+date+"&debut="+heure_debut+"&fin="+heure_fin;
